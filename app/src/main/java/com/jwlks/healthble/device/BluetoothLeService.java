...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        // http://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer.aspx?u=org.bluetooth.characteristic.TARGET_CHARACTERISTIC.xml
//        if (UUID_TARGET_CHARACTERISTIC.equals(characteristic.getUuid())) {
...
//        }
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter:READ not initialized");
            return;
        }
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic, byte[] data) {
        if(mBluetoothGatt.connect() && characteristic != null){
            characteristic.setValue(data);
            mBluetoothGatt.writeCharacteristic(characteristic);
        } else {
            Log.w(TAG, "BluetoothAdapter:WRITE not initialized");
        }
    ...
    public BluetoothGattCharacteristic getTargetMeasurementService() {
        if (mBluetoothGatt == null) return null;
        return mBluetoothGatt.getService(UUID_TARGET_SERVICE).getCharacteristic(UUID_TARGET_CHARACTERISTIC);
    }
}
